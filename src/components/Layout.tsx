        ...
        <header className={`sticky top-0 z-30 border-b backdrop-blur-sm ${isDark ? 'border-slate-800 bg-slate-950/80' : 'border-slate-200 bg-white/80'}`}>
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button type="button" className="rounded-xl bg-gradient-to-r from-amber-500 to-orange-400 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-amber-500/20 transition hover:brightness-110">
                {newServiceLabel}
              </button>
            </div>
          </div>
